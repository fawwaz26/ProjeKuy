<?php
	...
	private $error = array();
      ...
      if (isset($this->request->get['job_filter'])) {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($employ_total) ? (($page - 1) * 15) + 1 : 0, ((($page - 1) * 15) > ($employ_total - 1)) ? $employ_total : ((($page - 1) * 15) + 1), $employ_total, ceil($employ_total / 15));
