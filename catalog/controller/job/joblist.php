...
class ControllerJobJoblist extends Controller {
	...
	public function index() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($job_total) ? (($page - 1) * 12) + 1 : 0, ((($page - 1) * 12) > ($job_total - 1)) ? $job_total : ((($page - 1) * 12) + 1), $job_total, ceil($job_total / 12));
