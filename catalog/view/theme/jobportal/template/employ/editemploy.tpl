        ...
        <fieldset id="account">
          <legend><?php echo $text_your_details; ?></legend>
			...
			<div class="form-group">
				<div class="form-group required">
					<label class="col-sm-2 control-label" for="input-cvupload"><?php echo $entry_resume; ?></label>
	...
	<div class="form-group required">
        ...
        <fieldset id="address">
          <legend><?php echo $text_your_address; ?></legend>
			...
			<div class="form-group required">
				<label class="col-sm-12" for="input-about_self"><?php echo $entry_about;?></label>
				<div class="col-sm-12">
