    ...
    <div id="content" class="<?php echo $class; ?> login-form"><?php echo $content_top; ?>
		<div class="col-sm-offset-2 col-md-8 col-xs-12">
			<div class="form">
				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="form-group required">
						...
						<div class="form-group required">
							<label class="col-sm-12" for="input-date-available"><?php echo $entry_jobtype; ?></label>
                            <div class="col-sm-12">
					...
					<div class="form-group required">
						<label class="col-sm-12"><?php echo $entry_jobcategory; ?></label>
                        <div class="col-sm-12">
					...
					<legend><?php echo $text_your_address; ?></legend>
						...
						<div class="form-group required">
							<label class="col-sm-12" for="input-package-title"><?php echo $entry_about;?></label>
							<div class="col-sm-12">
			...
			<div class="form-group uploadresume">
						<label class="col-sm-2 control-label" for="input-lastname"><?php echo $entry_resume; ?></label>
				 <div class="col-sm-8">		
