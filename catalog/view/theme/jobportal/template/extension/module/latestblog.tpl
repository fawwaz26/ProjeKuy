	...
	<div class="blog">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<div class="box">
						<a href="blog.html">
							<img src="image/b1.jpg" alt="b1" title="b1" class="img-responsive" />
						</a>
						<div class="matter">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<div class="box">
						<a href="blog.html">
							<img src="image/b3.jpg" alt="b3" title="b3" class="img-responsive" />
						</a>
						<div class="matter">
							<h1>Tonsectetur adipiscing elit. Viva mus id interdum nibh, eu</h1>
							<p>Aestibulum nec mauris sapien. Vestibulum ultricies quam sit amet pretium rutrum. Etiam tempus lacus in sem imperdiet ...</p>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<div class="box">
						<a href="blog.html">
							<img src="image/b4.jpg" alt="b4" title="b4" class="img-responsive" />
						</a>
						<div class="matter">
							<h1>Tonsectetur adipiscing elit. Viva mus id interdum nibh, eu</h1>
							<p>Aestibulum nec mauris sapien. Vestibulum ultricies quam sit amet pretium rutrum. Etiam tempus lacus in sem imperdiet ...</p>
