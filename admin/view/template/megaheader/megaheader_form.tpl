...
<div id="content">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-body">
		...
		<!--Start Joblist-->
			<div id="joblist" class="form-group colors" style="display:none">
				<label class="col-sm-2 control-label" for="input-joblist"><span data-toggle="tooltip" title="<?php echo $help_category; ?>"><?php echo $entry_joblist ?></span></label>
				<div class="col-sm-10">
	...
	<!-- new code start here -->
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><?php echo $text_label;  ?></label>
					<div class="col-sm-10">
						<input type="text" name="menu_label" value="<?php echo $menu_label?>" placeholder="<?php echo $text_label;  ?>" class="form-control" />
					</div>
				</div>					
				<!-- new code end here -->		
			</div>
