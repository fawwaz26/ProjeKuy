				...
				<div class="row">
					<div class="col-sm-5">
						<div class="form-group">
							<label class="control-label" for="input-name"><?php echo $column_full_name; ?></label>
							<input type="text" name="filter_full_name" value="<?php echo $filter_full_name ?>" placeholder="<?php echo $column_full_name; ?>" id="input-full_name" class="form-control" />
						</div>
					</div>
