          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-filter_company_id"><?php echo $entry_company_name;?> </label>
                <input type="text" name="filter_company_id" value="<?php echo $filter_company_id; ?>" placeholder="<?php echo $entry_company_name; ?>" id="input-filter_company_id" class="form-control" />
                <input type="hidden" name="company_id" value=""/>
              </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group">
                <label class="control-label" for="input-experience"><?php echo $entry_experience;?> </label>
                <input type="text" name="filter_experience" value="<?php echo $filter_experience; ?>" placeholder="<?php echo $entry_experience; ?>" id="input-filter_experience" class="form-control" />
                </div>
              </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($list['approve']) { ?>
                    ...
                    <a href="<?php echo $list['disapproved']; ?>" data-toggle="tooltip" title="<?php echo $button_desapprove; ?>" class="btn btn-success"><i class="fa fa-thumbs-o-down"></i></a>
                    <?php } else { ?>
