  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">	
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
            ...
            <div class="form-group required">
        <label class="col-sm-2 control-label" for="input-package-title"><?php echo $entry_company_name;?></label>
        <div class="col-sm-10">
          ...
          <input type="hidden" name="category_id" value="<?php echo $category_id ?>">
			...
			<div class="form-group required">
                <label class="col-sm-2 control-label" for="input-package-title">
                  <?php echo $entry_confirm_password;?></label>
                <div class="col-sm-10">
			...
			<div class="form-group hide">
				<label class="col-sm-2 control-label" for="input-customer"><?php echo $entry_industry; ?></label>
				<div class="col-sm-10">
					<select  name="industry_id" id="input-industry_id" class="form-control">
						<option value=""><?php echo $text_select?></option>
						<?php foreach($industry as $result){ ?>
						<option value="<?php echo $result['industry_id']; ?>" <?php if(isset($industry_id) && $industry_id==$result['industry_id']) { echo "selected"; }?>><?php echo $result['industry_name']; ?></option> 
						<?php } ?>
					</select>
				</div>
			</div>
			<div class="form-group hide">
				<label class="col-sm-2 control-label" for="input-customer"><?php echo $entry_org_type; ?></label>
				<div class="col-sm-10">
					<select  name="orgtype_id" id="input-orgtype_id" class="form-control">
						<option value=""><?php echo $text_select?></option>
						<?php foreach($orgtype as $result){ ?>
						<option value="<?php echo $result['orgtype_id']; ?>" <?php if(isset($orgtype_id) && $orgtype_id==$result['orgtype_id']) { echo "selected"; }?>><?php echo $result['orgtype_name']; ?></option> 
						<?php } ?>
					</select>
				</div>
			</div>
    ...
    <div class="form-group required">
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" for="input-officeopen"><?php echo $entry_officeopen; ?></label>
        <div class="col-sm-10">
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" for="input-officeclose"><?php echo $entry_officeclose; ?></label>
        <div class="col-sm-10">
      ...
      <div class="form-group required">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="input-package-title">
            <?php echo $entry_company_descri;?></label>
            <div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-image"><?php echo $entry_company_image; ?></label>
