        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content col-sm-9">
			...
			<div class="tab-pane fade" id="tab-color">
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-titletextcolor"><?php echo $entry_titletextcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-blogtextcolor"><?php echo $entry_blogtextcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-titlebgcolor"><?php echo $entry_titlebgcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-themehovercolor"><?php echo $entry_themehovercolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-containerbgcolor"><?php echo $entry_containerbgcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-postboxbgcolor"><?php echo $entry_postboxbgcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-articletextcolor"><?php echo $entry_articletextcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-descptextcolor"><?php echo $entry_descptextcolor; ?></label>
                    <div class="col-sm-8">
