    ...
    <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
			 <ul class="nav nav-tabs">
				...
				<li><a href="#footerelement"   data-toggle="tab"><?php echo $entry_footerelement; ?></a></li>
          	</ul>
			<div class="tab-content">
					...
					<div class="table-responsive">
						<table id="hdr" class="table table-striped table-bordered table-hover">
							...
							<tr>
							 ...
							 <td class="text-left">Testimonial 1</td>
								</tr>
								<tr>
							...
							<td class="text-left">testimonial2</td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="table-responsive">
						<table id="hdr" class="table table-striped table-bordered table-hover">
							...
							<tr>
							 ...
							 <td class="text-left">search 1</td>
								</tr>
								<tr>
					...
					<div class="table-responsive">
						<table id="hdr" class="table table-striped table-bordered table-hover">
							...
							<tr>
							 ...
							 <td class="text-left">jobcategory 1</td>
								</tr>
								<tr>
							...
							<td class="text-left">jobcategory2</td>
								</tr>
							</tbody>
						</table>
					</div>
               ...
               <div class="form-group">
				<label class="col-sm-2 control-label" for="input-mapcode"><?php echo $entry_mapcode; ?></label>
				<div class="col-sm-10">
			 ...
			 <div class="tab-pane " id="footerelement">
			 	...
			 	<div class="form-group">
                <label class="col-sm-2 control-label" for="input-ftitle"><?php echo $entry_titlef; ?></label>
                <div class="col-sm-10">
				...
				<div class="form-group">
				<label class="col-sm-2 control-label" for="input-email"><?php echo $entry_flicker; ?></label>
				<div class="col-sm-10">
                ...
                <div class="form-group"> 
                <label class="col-sm-2 control-label" for="input-email"><?php echo $entry_textuseful; ?></label>
				<div class="col-sm-10">	
				<div class="table-responsive">
